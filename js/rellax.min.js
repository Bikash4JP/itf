...
(function(C, g) {
    ...
    var C = function(g, q) {
        ...
        var Q = window.cancelAnimationFrame || window.mozCancelAnimationFrame || clearTimeout,
        ...
        if (0 < g.length) {
            ...
            // Check for window.rellaxAutoInit flag before auto-initializing
            if (window.rellaxAutoInit !== false) {
                F();
            }
            a.refresh = F;
            return a
