  ...
  <style>
    ...
    *::after {
    ...
    .btn-primary:hover {
      ...
      box-shadow: 0 10px 30px rgba(59, 158, 255, .55);
    }
    ...
    .format-thumb.basic {
      background: linear-gradient(135deg, rgba(59, 158, 255, .2), rgba(59, 158, 255, .05));
      color: #7dc8ff;
    }

    .format-thumb.kaigo {
      background: linear-gradient(135deg, rgba(63, 185, 80, .2), rgba(63, 185, 80, .05));
      color: #56d364;
    }

    .format-thumb.soon {
      background: linear-gradient(135deg, rgba(124, 58, 237, .2), rgba(124, 58, 237, .05));
      color: #a78bfa;
      opacity: .7;
    }
    ...
    <div class="nav-logo">
      <div class="nav-logo-mark">
        <img src="https://it-future.jp/images/android-chrome-192x192.png" alt="ITF"
          onerror="this.style.display='none';this.parentElement.textContent='ITF'">
      </div>
      <div>
  ...
  <section class="wrap">
    <div class="hero">
        ...
        <?php if ($loggedIn && $user): ?>
          <div class="hero-return-bar">
            <div class="logged-in-hero-row">
              ...
              <a class="btn-edit-resume" href="/rireki/basic/rireki.php"
                style="color:#56d364;background:rgba(63,185,80,.1);border-color:rgba(63,185,80,.25)">
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
                  <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7" />
                  <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z" />
                </svg>
        ...
        <?php else: ?>
          <div class="hero-return-bar">
            <div class="return-pill">
              ...
              <a
                href="/php/user_login.php?next=<?= urlencode('/rireki/kaigo/php/rireki_preview.php?flow=profile_only') ?>">ログインして続ける
                →</a>
            </div>
          </div>
        <?php endif; ?>
      ...
      <div class="hero-visual">
        <img src="https://it-future.jp/rireki/images/intro_image.png" alt="オンライン履歴書メーカーのプレビュー" loading="eager"
          fetchpriority="high" width="720" height="480">
        ...
        <div class="resume-grid">
          ...
          <?php if (!isset($profiles['basic'])): ?>
            <div class="empty-card">
              ...
              <a class="btn-ghost" href="/php/user_login.php?next=/rireki/basic/rireki.php&fmt=basic"
                style="display:inline-flex;font-size:13px">作成する</a>
            </div>
          <?php endif; ?>
          <?php if (!isset($profiles['kaigo'])): ?>
            <div class="empty-card">
              ...
              <a class="btn-ghost" href="/php/user_login.php?next=/rireki/kaigo/rireki.php&fmt=kaigo"
                style="display:inline-flex;font-size:13px">作成する</a>
            </div>
          <?php endif; ?>
        </div>
  ...
  <section class="wrap formats-section" id="formats">
    ...
    <div class="format-grid">
      ...
      <article class="format-card">
        ...
        <div class="format-cta">
          <a class="btn-ghost" href="/php/user_login.php?next=/rireki/kaigo/rireki.php&fmt=kaigo"
            style="display:inline-flex;width:100%;justify-content:center;padding:12px;background:linear-gradient(135deg,var(--sky),var(--sky2));border:none;color:#fff">
            このフォーマットで作成
          </a>
        </div>
      </article>
      ...
      <article class="format-card">
        ...
        <div class="format-cta">
          <button class="btn-ghost" style="width:100%;justify-content:center;opacity:.5;cursor:not-allowed"
            disabled>準備中</button>
        </div>
      </article>
  </section>
    ...
    <div class="footer-container">
      <div class="footer-row">
        <div class="footer-col">
          ...
          <p class="footer-text">〒556-0017 大阪府大阪市浪速区湊町1-4-38 近鉄新難波ビル10F<br>06-6644-1800<br>〒144-0052
            東京都大田区蒲田5丁目21-13<br>03-6424-7747<br>info@it-future.jp</p>
        </div>
        <div class="footer-col">
