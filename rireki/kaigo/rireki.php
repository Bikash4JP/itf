...
<head>
  ...
  <style>
    ...
    .nav{display:flex;gap:12px;justify-content:flex-end;margin-top:12px}
    ...
    @media (max-width: 900px){
      .table.edu col.inst { width:38% }
      .table.work col.org  { width:30% }
    }
  </style>
</head>
<body>
        ...
        <section class="step-pane">
          ...
          <table class="table work" id="expTable">
            <colgroup>
              ...
              <col class="org"><col class="title">
              <col class="time"><col class="time"><col class="days"><col class="ops">
            </colgroup>
            <thead>
              <tr>
                ...
                <th>開始時間</th><th>終了時間</th><th>週日数</th><th>操作</th>
              </tr>
            </thead>
            <tbody>
              <tr class="exp-row">
                ...
                <td><input class="in-hhmm" type="text" name="work_blocks[work_time_start][]" placeholder="09:00" inputmode="numeric" pattern="\d{2}:\d{2}"></td>
                <td><input class="in-hhmm" type="text" name="work_blocks[work_time_end][]"   placeholder="18:00" inputmode="numeric" pattern="\d{2}:\d{2}"></td>
                <td><input class="in-mm" type="text" name="work_blocks[work_days_per_week][]" placeholder="5" inputmode="numeric"></td>
