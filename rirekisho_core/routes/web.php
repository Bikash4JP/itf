...
Route::get('/wizard/fake', function () {
    $sample = [
        "template" => "basic",
        "name_kanji" => "山田 太郎",
        "name_kana" => "ヤマダ タロウ",
        ...
        "residence_expiry" => "2027-03-31",
        "language_skills" => "日本語N2、英語ビジネス、ネパール語母国語",
        "postal_code" => "123-4567",
        "address_full" => "東京都新宿区西新宿2-8-1",
        "phone" => "080-1234-5678",
        "email" => "taro@example.com",
        "education" => [
            [ "year"=>"2010", "month"=>"04", "school"=>"カトマンズ高校 入学" ],
            [ "year"=>"2013", "month"=>"03", "school"=>"カトマンズ高校 卒業" ],
            [ "year"=>"2014", "month"=>"04", "school"=>"東京国際大学 入学" ],
            [ "year"=>"2018", "month"=>"03", "school"=>"東京国際大学 卒業" ],
        ],
        "work" => [
            [ "from_year"=>"2018", "from_month"=>"04", "company"=>"株式会社ABC システムエンジニア" ],
            [ "from_year"=>"2021", "from_month"=>"07", "company"=>"株式会社XYZ Webエンジニア" ],
        ],
        "licenses" => [
            [ "year"=>"2017", "month"=>"07", "title"=>"JLPT N2 合格" ],
            [ "year"=>"2020", "month"=>"12", "title"=>"普通自動車第一種運転免許" ],
        ],
        "motivation" => "御社のDX事業に強く関心を持ち…",
        "self_pr" => "Webシステム開発5年、チームリーダー経験あり。",
        "preferences" => "勤務地：首都圏希望。在宅勤務可。",
        "uploads" => [
            "photo_path" => "uploads/photos/abcd1234.jpg"
        ]
    ];

    session(['wizard' => $sample]);
    return redirect()->route('rirekisho.step7');
});
